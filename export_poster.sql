...
CREATE TABLE `favorites` (
  `favoriteNumber` int NOT NULL AUTO_INCREMENT,
  `userNumber` int NOT NULL,
  `postNumber` int NOT NULL,
  PRIMARY KEY (`favoriteNumber`)
...
CREATE TABLE `users` (
  ...
  `selfIntroduction` text COLLATE utf8mb4_general_ci,
...
INSERT INTO `users` VALUES (1,'かずま','kzmeorna','kazuma.engineer@gmail.com','$2y$10$T9p7EQ8JseC2A.F4xEWmW.GLPvDRCEBARZCz5phdoIfOPcS9LcJjy',NULL);
...
-- Dump completed on 2021-05-04 14:04:28
